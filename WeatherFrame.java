...
public class WeatherFrame extends JFrame {
    ...
    private void initComponents() {
        ...
        //Lambda expression for month combo box
        monthComboBox.addItemListener((java.awt.event.ItemEvent event) -> {
            dayComboBox.removeAllItems();
            fillDayComboBox(yearsList.get(yearComboBox.getSelectedIndex())
                    .months.get(monthComboBox.getSelectedIndex()));
        });
        ...
        //set text for the file menu bar item
        FileMenu.setText("File");

        //set text for open menu item 
        ...
        //Set text for the close menu item
        ...
        //Set text for Help menu bar item
    ...
    /*==========================================================================
        Function: CloseMenuItemActionPerformed()

        Description: 
            This function closes the application once the user clicks on the 
        close button under "File".
